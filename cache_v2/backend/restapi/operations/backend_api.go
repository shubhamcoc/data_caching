...
func NewBackendAPI(spec *loads.Document) *BackendAPI {
	return &BackendAPI{
		...
		GetSearchbyIDHandler: GetSearchbyIDHandlerFunc(func(params GetSearchbyIDParams) middleware.Responder {
			return middleware.NotImplemented("operation GetSearchbyID has not yet been implemented")
		}),
		PostSubmitHandler: PostSubmitHandlerFunc(func(params PostSubmitParams) middleware.Responder {
			return middleware.NotImplemented("operation PostSubmit has not yet been implemented")
		}),
	}
}

/*BackendAPI EM Backend server APIs */
type BackendAPI struct {
	...
	// GetSearchbyIDHandler sets the operation handler for the get searchby ID operation
	GetSearchbyIDHandler GetSearchbyIDHandler
	// PostSubmitHandler sets the operation handler for the post submit operation
...
func (o *BackendAPI) Validate() error {
	...
	if o.GetSearchbyIDHandler == nil {
		unregistered = append(unregistered, "GetSearchbyIDHandler")
	}
	if o.PostSubmitHandler == nil {
		unregistered = append(unregistered, "PostSubmitHandler")
	}
...
func (o *BackendAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/searchbyID"] = NewGetSearchbyID(o.context, o.GetSearchbyIDHandler)
	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/submit"] = NewPostSubmit(o.context, o.PostSubmitHandler)
}
